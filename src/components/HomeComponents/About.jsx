...
const About = () => {
    ...
    return (
        <div className="my-20 max-w-[1500px] w-[90%] mx-auto">
            <h1 className="text-5xl text-center font-bold text-primaryColor">The Most Popular And <br /> Number 1 Mail App.</h1>
            <p className="max-w-[700px] text-center mx-auto mt-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit aperiam laborum perspiciatis harum asperiores eos nemo sed in praesentium eius eligendi ad, ea illo maxime molestiae eum aliquam ipsam. Dolore?</p>
            <div className="my-12">
                <Swiper
                    slidesPerView={1}
                    spaceBetween={10}
