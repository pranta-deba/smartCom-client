...
const CompanyHeader = () => {
    ...
    return (
        <div>
            ...
            >
                <SwiperSlide>
                    <div style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0,0.9)),` }} className="bg-[#07332F] bg-cover bg-no-repeat flex justify-center text-center py-8">
