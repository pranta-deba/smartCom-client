    ...
    return (
        <div className='min-h-[calc(100vh-132.469px)]'>
            <div>
                ...
                >
                    <SwiperSlide>
                        <div style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(0,0,0,0.9)), url(${banner})` }} className="bg-cover bg-no-repeat flex justify-center items-center text-center py-8 min-h-[calc(100vh-68.500px)]">
